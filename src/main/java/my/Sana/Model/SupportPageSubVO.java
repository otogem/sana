...
public class SupportPageSubVO {
	...
	//SupportPageVO 포함
	private SupportPageVO spa;
	//supportlist테이블의 전체건수를 저장
	private int total;
	
	//생성자(매개변수가 2개인 생성자) 선언
	public SupportPageSubVO(SupportPageVO spa,int total) {
		this.spa=spa;
		this.total=total;
	...
	public SupportPageVO getSpa() {
		return spa;
	}
	public void setSpa(SupportPageVO spa) {
		this.spa = spa;
	}
	public int getTotal() {
		return total;
	...
	public String toString() {
		return "SupportPageSub [startPage=" + startPage + ", endPage=" + endPage + ", prev=" + prev + ", next="
				+ next + ", spa=" + spa + ", total=" + total + "]";
	}
}
