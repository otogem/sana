...
public class PostUploadController {
	...
	@RequestMapping(value="/PostuploadAjaxAction",method=RequestMethod.POST)
	public ResponseEntity<ArrayList<PostFileVO>> uploadAjaxPost(MultipartFile[] uploadFile) {
		
		//ServiceFileListVO클래스 포함
		ArrayList<PostFileVO> list = new ArrayList();
		...
		//PostFailVO클래스의 새로운 주소를 반복적으로 생성하여
		//ArrayList에 저장
	...
	//다운로드 주소 생성
	@RequestMapping(value="/postdownload",method=RequestMethod.GET)
